      ...
      <div className="max-w-4xl bg-white p-8 rounded-lg shadow-xl">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-2">
            ...
            <textarea id="message" name="message" rows="5" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></textarea>
          </div>
        </form>
